                ...
                <tbody>
                    ...
                    {props._state.isElectric === "electric" ?
                        <tr>
                            ...
                            <th>${((((parseFloat(props._state.miles) * 52) / parseFloat(props._state.fullcharge)) * parseFloat(props._state.fullchargeCost))).toFixed(0)}</th>
                        </tr>
                        :
                        <tr>
                            <th>Gas</th>
